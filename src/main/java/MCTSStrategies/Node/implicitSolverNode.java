...
/**
 * Node class which allows the adapted Ludii MCTS class to be used with an solver and implicit MCTS.
 */
public class implicitSolverNode extends implicitNode {

    /**
     * Constructor for the implicit solver node
     *
     ...
     */
    public implicitSolverNode(MCTS mcts, BaseNode parent, Move parentMove, Move parentMoveWithoutConseq, Context context,
        ...
        super(mcts, parent, parentMove, parentMoveWithoutConseq, context,
                leafEvaluator, terminalStateEvaluator, evaluateBatched);
            ...
            for (int i = 0; i < numLegalMoves; i++) {
                ...
                if (contextCopy.trial().over()){
                    ...
                    if (utilities[mover] == 1){
                        ...
                        this.addChild(new implicitSolverNode(mcts, this, contextCopy.trial().lastMove(),
                                this.nthLegalMove(i), contextCopy, leafEvaluator,
                                terminalStateEvaluator, evaluateBatched), i);
                    ...
                    if (child == null || child.totalScore(mover) != -Value.INF){
                        ...
                        while (current != null){
                            synchronized (current){
                                ...
                                if (updateGRAVE)
                                {
                                    ((implicitSolverNode)current).updateRave(moveKeysAMAF, tempUtil, mover);
                                }
                            }
