 ...
 * However, instead of multiplying all children with the same exploration constant, a softmax with temperature
 * 1/n_c is used to transform the estimated values to probabilities which are multiplied with the exploration.
 * For this implementation, the ln in the exploration is removed (inspired by Polygames)
 */
public class ImplicitUCTRescaledExploration5 extends ImplicitUCT {
     ...
     */
    public ImplicitUCTRescaledExploration5(double influenceEstimatedMinimax, Softmax rescaler) {
     ...
     * softmax with temperature 1/n_c on the estimated values, and the ln in the exploration formula is removed
