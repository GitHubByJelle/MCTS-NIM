 ...
 * is used to transform the estimated values to probabilities which are multiplied with the exploration.
 */
public class ImplicitUCTRescaledExploration6 extends ImplicitUCT {
     ...
     */
    public ImplicitUCTRescaledExploration6(double influenceEstimatedMinimax, Softmax rescaler) {
