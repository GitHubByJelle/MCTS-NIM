 ...
 * decreasing alpha. The uct is multiplied with 1+random constant to increase exploration
 */
public class ImplicitUCTAlphaDecreaseRandomConstant extends ImplicitUCT {
