 ...
 * However, instead of only multiplying all children with the same exploration constant, a softmax with temperature
 * C/n_c is used to transform the estimated values to probabilities which are multiplied with the exploration.
 */
public class ImplicitUCTRescaledExploration8 extends ImplicitUCT {
     ...
     */
    public ImplicitUCTRescaledExploration8(double influenceEstimatedMinimax, double explorationConstant, Softmax rescaler) {
