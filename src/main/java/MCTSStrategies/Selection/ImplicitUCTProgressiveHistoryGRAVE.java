...
/**
 * Selection strategy which selects the child based on a combination of UCT, minimax backpropagated values, Progressive
 * History and GRAVE
 */
public class ImplicitUCTProgressiveHistoryGRAVE extends ImplicitUCT {
    ...
    /**
     * Constructor with no inputs (Threshold number=100, weight used in AMAF=10.e-6, influence=0.4,
     * progressive weights=0.3 and exploration=sqrt(2))
     */
    public ImplicitUCTProgressiveHistoryGRAVE() {
        this(100, 10.e-6, 0.4, 3.0, Math.sqrt(2.0));
    }
...
//                        i, exploit, estimatedValue, meanScore, beta, meanAMAF, explore, uctGraveValue);
//            }
