 ...
 * transform the estimated values to probabilities which are multiplied with the exploration.
 */
public class ImplicitUCTRescaledExploration2 extends ImplicitUCT {
     ...
     */
    public ImplicitUCTRescaledExploration2(double influenceEstimatedMinimax, Softmax rescaler) {
     ...
     * softmax on the estimated values.
     *
