 ...
 * values.
 */
public class ImplicitMCTSNNNP37 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, QInit=INF, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP37(String pathName) {
