 ...
 * values.
 */
public class ImplicitMCTSNNNP41 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, minimum influence of estimated values = 0.2,
     * QInit=PARENT, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP41(String pathName) {
     ...
     */
    public ImplicitMCTSNNNP41(String pathName, float alpha, float explorationConstant, float slope) {
