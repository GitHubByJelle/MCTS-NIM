...
/**
 * MCTS search algorithm using neural networks and transposition tables with enhanced Implicit UCT, no play-outs, while
 ...
 * values.
 */
public class ImplicitMCTSNNNP47 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNP47(String pathName) {
