 ...
 */
public class ImplicitMCTSNNNP4 extends MCTS {
     ...
     * (solver=true, influence estimated value = 0.8, exploration=0.01, QInit=DRAW, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP4(String pathName) {
        super(new ImplicitUCT(.8, .01f), new RandomPlayout(0),
