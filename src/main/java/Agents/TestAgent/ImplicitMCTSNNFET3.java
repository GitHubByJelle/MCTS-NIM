 ...
 */
public class ImplicitMCTSNNFET3 extends MCTS {
     ...
     * (solver=true, influence estimated value = 0.8, exploration=0.001, QInit=PARENT, epsilon=0.05, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNFET3(String pathName) {
     ...
     */
    public ImplicitMCTSNNFET3(String pathName, float alpha, float explorationConstant) {
