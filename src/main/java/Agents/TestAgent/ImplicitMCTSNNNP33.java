 ...
 * values.
 */
public class ImplicitMCTSNNNP33 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, random constant=.05, QInit=PARENT, 6 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP33(String pathName) {
