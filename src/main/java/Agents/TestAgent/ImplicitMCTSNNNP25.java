 ...
 */
public class ImplicitMCTSNNNP25 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=0.001, slope=0.05, random constant=.1, QInit=PARENT, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP25(String pathName) {
