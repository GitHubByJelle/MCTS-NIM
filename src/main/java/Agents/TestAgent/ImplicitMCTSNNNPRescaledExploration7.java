...
import MCTSStrategies.Selection.ImplicitUCTRescaledExploration7;
 ...
 * is calculated using softmax with temperature (T=1/parent visits). The exploration is changed to 1/child
 * visits (inspired by AlphaZero).
 */
public class ImplicitMCTSNNNPRescaledExploration7 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNPRescaledExploration7(String pathName) {
        super(new ImplicitUCTRescaledExploration7(.8, new Softmax()), new RandomPlayout(0),
