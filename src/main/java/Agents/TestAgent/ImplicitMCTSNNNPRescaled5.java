 ...
 */
public class ImplicitMCTSNNNPRescaled5 extends MCTS {
     ...
     * (solver=true, influence estimated value = 1, exploration=0.01, multiplier=2, QInit=DRAW, 6 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNPRescaled5(String pathName) {
        super(new ImplicitUCTRescaled(1, .001f, new MultiplyDifferences(2)),
