...
import MCTSStrategies.Selection.ImplicitUCTAlphaDecreaseRescaledExploration01;
 ...
 * values.
 */
public class ImplicitMCTSNNNP44 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNP44(String pathName) {
        super(new ImplicitUCTAlphaDecreaseRescaledExploration01(.8, 2,
                        new Softmax(), 1 / 20f),
                new RandomPlayout(0),
     ...
     */
    public ImplicitMCTSNNNP44(String pathName, float alpha, float explorationConstant, float slope) {
