 ...
 * values.
 */
public class ImplicitMCTSNNNP39 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=3, slope=0.02, QInit=PARENT, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP39(String pathName) {
        super(new ImplicitUCTAlphaDecreaseRescaledExploration(.8, 3,
                        new Softmax(), .02f),
                new RandomPlayout(0),
