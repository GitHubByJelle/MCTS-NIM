 ...
 */
public class ImplicitMCTSNNNP3 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNP3(String pathName) {
     ...
     */
    public ImplicitMCTSNNNP3(String pathName, float alpha, float explorationConstant) {
