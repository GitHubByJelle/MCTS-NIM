 ...
 */
public class ImplicitMCTSNNNP15 extends MCTS {
     ...
     * (influence estimated value = 0.8, exploration=sqrt(2), QInit=PARENT, 4 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP15(String pathName) {
        super(new ImplicitUCT(.8, Math.sqrt(2)), new RandomPlayout(0),
