 ...
 * backpropagating the estimated value by the network, and robust child with solver. Instead of using the same value for alpha
 ...
 * values.
 */
public class ImplicitMCTSNNNP34 extends MCTS {
     ...
     * (solver=true, initial influence estimated value = 0.8, exploration=2, slope=0.05, QInit=PARENT, 4 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP34(String pathName) {
