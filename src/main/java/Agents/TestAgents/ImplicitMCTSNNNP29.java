 ...
 * values.
 */
public class ImplicitMCTSNNNP29 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, QInit=PARENT, 6 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP29(String pathName) {
     ...
     * exploration value, and slope as input. (QInit=PARENT, 6 threads)
     *
     * @param pathName            Path to the desired neural network
     * @param alpha               influence of the estimated value
     * @param explorationConstant exploration constant
     */
    public ImplicitMCTSNNNP29(String pathName, float alpha, float explorationConstant, float slope) {
