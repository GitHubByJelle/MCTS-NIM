 ...
 */
public class AlphaBetaSearchNN extends AI {
    ...
    public static AlphaBetaSearchNN createAlphaBeta() {
        return new AlphaBetaSearchNN();
    }

    /**
     * Constructor with no inputs
     */
    public AlphaBetaSearchNN() {
     ...
     */
    public AlphaBetaSearchNN(String pathName) {
        this.allowedSearchDepths = AllowedSearchDepths.Any;
        this.friendlyName = "Alpha-Beta with NN evaluation";
...
//        System.out.println("Iterations per sec: " + iterations / maxSeconds);
    ...
    public float alphaBeta(Context context, int depth, float inAlpha, float inBeta, int maximisingPlayer, long stopTime) {
        ...
        if (!trial.over() && context.active(maximisingPlayer)) {
            ...
            // Terminal evaluation
            return this.terminalEvaluator.evaluate(context, 1);
        }
    }
    ...
    public AI.AIVisualisationData aiVisualisationData() {
        if (this.currentRootMoves != null && this.rootValueEstimates != null) {
            ...
            return new AI.AIVisualisationData(aiDistribution, this.rootValueEstimates, this.currentRootMoves);
        } else {
            return null;
        }
    }
