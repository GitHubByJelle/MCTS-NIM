 ...
 * values.
 */
public class ImplicitMCTSNNNP36 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, QInit=DRAW, 4 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP36(String pathName) {
