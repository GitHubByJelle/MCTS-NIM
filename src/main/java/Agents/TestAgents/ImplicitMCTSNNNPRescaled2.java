 ...
 */
public class ImplicitMCTSNNNPRescaled2 extends MCTS {
     ...
     * (solver=true, influence estimated value = 0.8, exploration=0.01, multiplier=2, QInit=DRAW, 6 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNPRescaled2(String pathName) {
