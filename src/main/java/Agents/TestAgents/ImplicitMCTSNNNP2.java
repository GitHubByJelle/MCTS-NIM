 ...
 */
public class ImplicitMCTSNNNP2 extends MCTS {
    //-------------------------------------------------------------------------
     ...
     */
    public ImplicitMCTSNNNP2(String pathName) {
     ...
     */
    public ImplicitMCTSNNNP2(String pathName, float alpha, float explorationConstant) {
