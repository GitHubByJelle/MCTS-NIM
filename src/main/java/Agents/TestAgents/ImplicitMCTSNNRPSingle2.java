...
/**
 * MCTS search algorithm using a neural network with Implicit UCT, random play-outs, while
 * backpropagating the estimated value by the network, and robust child with solver.
 */
public class ImplicitMCTSNNRPSingle2 extends MCTS {
     ...
     */
    public ImplicitMCTSNNRPSingle2(String pathName) {
    ...
    public void initAI(Game game, int playerID) {
        ...
        this.setLeafEvaluator(new NeuralNetworkLeafEvaluator(game,
                LearningManager.loadNetwork(pathName, false)), game);
