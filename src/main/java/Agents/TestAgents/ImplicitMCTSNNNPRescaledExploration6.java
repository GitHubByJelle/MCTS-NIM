 ...
 * is calculated using softmax with temperature (T=1/parent visits).
 */
public class ImplicitMCTSNNNPRescaledExploration6 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNPRescaledExploration6(String pathName) {
        super(new ImplicitUCTRescaledExploration6(.8, new Softmax()), new RandomPlayout(0),
