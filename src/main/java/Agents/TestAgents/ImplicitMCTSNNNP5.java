 ...
 */
public class ImplicitMCTSNNNP5 extends MCTS {
     ...
     * (solver=true, influence estimated value = 0.8, exploration=0.001, QInit=INF, 4 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP5(String pathName) {
        ...
        this.setQInit(QInit.INF);
    }

    /**
     * Constructor with the path to the desired neural network as string, the influence of the estimated value,
     * and exploration as input. (solver=true, QInit=INF, 4 threads)
     *
     * @param pathName            Path to the desired neural network
     * @param alpha               influence of the estimated value
     * @param explorationConstant exploration constant
     */
    public ImplicitMCTSNNNP5(String pathName, float alpha, float explorationConstant) {
