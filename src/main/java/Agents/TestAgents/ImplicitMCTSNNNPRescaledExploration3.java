...
import MCTSStrategies.Selection.ImplicitUCTRescaledExploration2;
import MCTSStrategies.Selection.ImplicitUCTRescaledExploration3;
 ...
 * is calculated using softmax. The exploration is changed to 1/child visits (inspired by AlphaZero).
 */
public class ImplicitMCTSNNNPRescaledExploration3 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNPRescaledExploration3(String pathName) {
        super(new ImplicitUCTRescaledExploration3(.8, new Softmax()), new RandomPlayout(0),
