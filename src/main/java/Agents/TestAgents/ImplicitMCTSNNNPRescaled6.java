 ...
 */
public class ImplicitMCTSNNNPRescaled6 extends MCTS {
     ...
     * (solver=true, influence estimated value = 0.8, exploration=0.001, multiplier=5, QInit=DRAW, 6 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNPRescaled6(String pathName) {
        super(new ImplicitUCTRescaled(.8, .001f, new MultiplyDifferences(5)),
