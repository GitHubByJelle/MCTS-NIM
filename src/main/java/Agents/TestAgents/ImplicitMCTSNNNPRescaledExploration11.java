 ...
 */
public class ImplicitMCTSNNNPRescaledExploration11 extends MCTS {
     ...
     * (influence estimated value = 0.8, exploration constant=2, QInit=PARENT, 6 threads)
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNPRescaledExploration11(String pathName) {
