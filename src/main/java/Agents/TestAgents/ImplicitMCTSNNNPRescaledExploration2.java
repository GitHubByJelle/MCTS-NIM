 ...
 */
public class ImplicitMCTSNNNPRescaledExploration2 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNPRescaledExploration2(String pathName) {
        super(new ImplicitUCTRescaledExploration2(.8, new Softmax()), new RandomPlayout(0),
