 ...
 * backpropagate win or loss), and robust child using the solver. It uses the Maarten Schadds Evaluation function, as
 ...
 */
public class ImplicitMCTSSolver extends MCTS {

    /**
     * Constructor requiring no inputs (solver=true, exploration=sqrt(2), influence estimated value = 0.4, bound = 0.4,
     * epsilon = 0.1, and 12 threads)
     */
    public ImplicitMCTSSolver() {
