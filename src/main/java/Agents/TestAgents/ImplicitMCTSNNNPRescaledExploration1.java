...
import MCTSStrategies.Selection.ImplicitUCTRescaledExploration1;
 ...
 * is calculated using softmax. The ln is removed from the exploration part (Inspired by Polygames).
 */
public class ImplicitMCTSNNNPRescaledExploration1 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNPRescaledExploration1(String pathName) {
        super(new ImplicitUCTRescaledExploration1(.8, new Softmax()), new RandomPlayout(0),
