 ...
 * values.
 */
public class ImplicitMCTSNNNP32 extends MCTS {
     ...
     * (initial influence estimated value = 0.8, exploration=2, slope=0.05, random constant=.1, QInit=PARENT, 6 threads)
     *
     * @param pathName Path to the desired neural network
     */
    public ImplicitMCTSNNNP32(String pathName) {
