...
import MCTSStrategies.Selection.ImplicitUCTAlphaIncrease;
 ...
 * the entire search, the alpha value increases when the number of visits increases with a specified slope
 */
public class ImplicitMCTSNNNP18 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNP18(String pathName) {
        super(new ImplicitUCTAlphaIncrease(.8, .001f, .05f),
                new RandomPlayout(0),
