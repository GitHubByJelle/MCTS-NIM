...
import MCTSStrategies.Backpropagation.ImplicitNoPlayoutTerminationBackprop;
 ...
 * backpropagating the implicit minimax value of the encountered game position,
 * and robust child.
 */
public class ImplicitMCTSNNNP49 extends MCTS {
     ...
     */
    public ImplicitMCTSNNNP49(String pathName) {
        super(new ImplicitUCT(.8, .0001f),
                new RandomPlayout(0),
                new ImplicitNoPlayoutTerminationBackprop(),
                new RobustChild());
...
//                new debugFinalSelectionWrapper(new RobustChild()));
     ...
     */
    public ImplicitMCTSNNNP49(String pathName, float alpha, float explorationConstant) {
